...
import static org.securemdc.authentication.AccountGeneral.sServerAuthenticate;
import static org.securemdc.authentication.AuthenticatorActivity.ARG_ACCOUNT_TYPE;
import static org.securemdc.authentication.AuthenticatorActivity.KEY_ERROR_MESSAGE;
import static org.securemdc.authentication.AuthenticatorActivity.PARAM_USER_PASS;
	...
	private void createAccount(){
		...
		new AsyncTask<String, Void, Intent>(){
			...
			protected Intent doInBackground(String... params) {
				Log.d("Secure MDC", TAG +"> Started authenticating");
